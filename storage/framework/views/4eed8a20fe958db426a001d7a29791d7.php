...
<div class="modal fade" id="createLetterModal" tabindex="-1" aria-labelledby="createLetterModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('letters.store')); ?>" method="POST" id="createLetterForm" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<?php /**PATH /Applications/MAMP/htdocs/SIRT02/resources/views/letters/partials/create-modal.blade.php ENDPATH**/ ?>