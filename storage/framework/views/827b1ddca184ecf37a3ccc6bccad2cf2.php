            ...
            <div class="container">
                            ...
                            <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-duration="600">
                                <div class="card news-card h-100">
                                    ...
                                    <div class="news-card-body">
                                        ...
                                        <h5 class="news-title"><?php echo e($item->title); ?></h5>
                                        <p class="news-excerpt">
                                            <?php echo e(Str::limit(strip_tags($item->content), 120, '...')); ?>

                                        </p>
                                        <div class="news-footer">
                                            <a href="<?php echo e(route('news.show', $item->slug)); ?>" class="read-more">
                                                Baca Selengkapnya 
                            ...
                            <div class="col-12">
                                <nav aria-label="Page navigation">
                                    <ul class="pagination justify-content-center">
                                        ...
                                        <?php else: ?>
                                            <li class="page-item"><a class="page-link" href="<?php echo e($news->previousPageUrl()); ?>">&laquo;</a></li>
                                        <?php endif; ?>
                                        ...
                                        <?php if($news->hasMorePages()): ?>
                                            <li class="page-item"><a class="page-link" href="<?php echo e($news->nextPageUrl()); ?>">&raquo;</a></li>
                                        <?php else: ?>
                ...
                <?php else: ?>
                    <div class="no-news">
                        ...
                        <a href="<?php echo e(route('index')); ?>" class="btn btn-back mt-4">Kembali ke Beranda</a>
                    </div>
                <?php endif; ?>
            </div>
        </section>
...
<?php /**PATH /Applications/MAMP/htdocs/SIRT02/resources/views/news/index.blade.php ENDPATH**/ ?>